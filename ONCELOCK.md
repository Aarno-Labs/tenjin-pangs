...
The analysis-owned `run.analysis.phase_stationarity_report` object is emitted whenever
the disposition facts are assembled. Its stable v1 fields are:

- `coverage.{certified_globals,client_relevant_mutable_globals}`;
- `quiescence_profile`, an array of every client-relevant mutable definition, sorted
